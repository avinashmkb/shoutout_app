class FeedbackTopicsController < ApplicationController
  # GET /feedback_topics
  ...
  def create
    ...
    respond_to do |format|
      if @feedback_topic.save
        format.html { redirect_to @feedback_topic, notice: 'Feedback topic was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @feedback_topic.update_attributes(params[:feedback_topic])
        format.html { redirect_to @feedback_topic, notice: 'Feedback topic was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to feedback_topics_url }
      format.json { head :no_content }
    end
  end
end
